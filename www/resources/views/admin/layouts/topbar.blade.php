...
{{--                                        key="t-ui-components">@lang('translation.UI_Components')</h5>--}}
...
{{--                                <div class="col-md-4">--}}
{{--                                    <h5 class="font-size-14 mt-0"--}}
{{--                                        key="t-applications">@lang('translation.Applications')</h5>--}}
{{--                                    <ul class="list-unstyled megamenu-list">--}}
{{--                                        <li>--}}
{{--                                            <a href="javascript:void(0);"--}}
...
{{--                                <div class="col-md-4">--}}
{{--                                    <h5 class="font-size-14 mt-0"--}}
{{--                                        key="t-extra-pages">@lang('translation.Extra_Pages')</h5>--}}
{{--                                    <ul class="list-unstyled megamenu-list">--}}
{{--                                        <li>--}}
{{--                                            <a href="javascript:void(0);"--}}
...
{{--                                    <h6 class="mt-0 mb-1"--}}
{{--                                        key="t-your-order">@lang('translation.Your_order_is_placed')</h6>--}}

    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="#"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('translation.Profile')</span></a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                            ...
                            <a href="#" class="dropdown-item" key="t-saas">@lang('translation.Saas')</a>
                            <a href="#" class="dropdown-item" key="t-crypto">@lang('translation.Crypto')</a>
                            <a href="#" class="dropdown-item" key="t-blog">@lang('translation.Blog')</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl"
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div>
                                        <a href="#" class="dropdown-item" key="t-alerts">@lang('translation.Alerts')</a>
                                        <a href="#" class="dropdown-item" key="t-buttons">@lang('translation.Buttons')</a>
                                        <a href="#" class="dropdown-item" key="t-cards">@lang('translation.Cards')</a>
                                        <a href="#" class="dropdown-item" key="t-carousel">@lang('translation.Carousel')</a>
                                        <a href="#" class="dropdown-item" key="t-dropdowns">@lang('translation.Dropdowns')</a>
                                        <a href="#" class="dropdown-item" key="t-grid">@lang('translation.Grid')</a>
                                        <a href="#" class="dropdown-item" key="t-images">@lang('translation.Images')</a>
                                        <a href="#" class="dropdown-item" key="t-lightbox">@lang('translation.Lightbox')</a>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div>
                                        <a href="#" class="dropdown-item" key="t-modals">@lang('translation.Modals')</a>
                                        <a href="#" class="dropdown-item" key="t-offcanvas">@lang('translation.Offcanvas')</a>
                                        <a href="#" class="dropdown-item" key="t-range-slider">@lang('translation.Range_Slider')</a>
                                        <a href="#" class="dropdown-item" key="t-session-timeout">@lang('translation.Session_Timeout')</a>
                                        <a href="#" class="dropdown-item" key="t-progress-bars">@lang('translation.Progress_Bars')</a>
                                        <a href="#" class="dropdown-item" key="t-placeholders">@lang('translation.Placeholders')</a>
                                        <a href="#" class="dropdown-item" key="t-sweet-alert">@lang('translation.Sweet_Alert')</a>
                                        <a href="#" class="dropdown-item" key="t-tabs-accordions">@lang('translation.Tabs_&_Accordions')</a>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div>
                                        <a href="#" class="dropdown-item" key="t-typography">@lang('translation.Typography')</a>
                                        <a href="#" class="dropdown-item" key="t-video">@lang('translation.Video')</a>
                                        <a href="#" class="dropdown-item" key="t-general">@lang('translation.General')</a>
                                        <a href="#" class="dropdown-item" key="t-colors">@lang('translation.Colors')</a>
                                        <a href="#" class="dropdown-item" key="t-rating">@lang('translation.Rating')</a>
                                        <a href="#" class="dropdown-item" key="t-notifications">@lang('translation.Notifications')</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-calendar">
                                <a href="#" class="dropdown-item" key="t-tui-calendar">@lang('translation.TUI_Calendar')</a>
                                <a href="#" class="dropdown-item" key="t-full-calendar">@lang('translation.Full_Calendar')</a>
                            </div>
                        </div>
                            <a href="#" class="dropdown-item" key="t-chat">@lang('translation.Chat')</a>
                            <a href="#" class="dropdown-item" key="t-file-manager">@lang('translation.File_Manager')</a>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    <a href="#" class="dropdown-item" key="t-inbox">@lang('translation.Inbox')</a>
                                    <a href="#" class="dropdown-item" key="t-read-email">@lang('translation.Read_Email')</a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-blog">
                                            <a href="#" class="dropdown-item" key="t-basic-action">@lang('translation.Basic_Action')</a>
                                            <a href="#" class="dropdown-item" key="t-alert-email">@lang('translation.Alert_Email')</a>
                                            <a href="#" class="dropdown-item" key="t-bill-email">@lang('translation.Billing_Email')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                    <a href="#" class="dropdown-item" key="t-products">@lang('translation.Products')</a>
                                    <a href="#" class="dropdown-item" key="t-product-detail">@lang('translation.Product_Detail')</a>
                                    <a href="#" class="dropdown-item" key="t-orders">@lang('translation.Orders')</a>
                                    <a href="#" class="dropdown-item" key="t-customers">@lang('translation.Customers')</a>
                                    <a href="#" class="dropdown-item" key="t-cart">@lang('translation.Cart')</a>
                                    <a href="#" class="dropdown-item" key="t-checkout">@lang('translation.Checkout')</a>
                                    <a href="#" class="dropdown-item" key="t-shops">@lang('translation.Shops')</a>
                                    <a href="#" class="dropdown-item" key="t-add-product">@lang('translation.Add_Product')</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-crypto">
                                    <a href="#" class="dropdown-item" key="t-wallet">@lang('translation.Wallet')</a>
                                    <a href="#-sell" class="dropdown-item" key="t-buy">@lang('translation.Buy_Sell')</a>
                                    <a href="#" class="dropdown-item" key="t-exchange">@lang('translation.Exchange')</a>
                                    <a href="#" class="dropdown-item" key="t-lending">@lang('translation.Lending')</a>
                                    <a href="#" class="dropdown-item" key="t-orders">@lang('translation.Orders')</a>
                                    <a href="#" class="dropdown-item" key="t-kyc">@lang('translation.KYC_Application')</a>
                                    <a href="#" class="dropdown-item" key="t-ico">@lang('translation.ICO_Landing')</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-project">
                                    <a href="#" class="dropdown-item" key="t-p-grid">@lang('translation.Projects_Grid')</a>
                                    <a href="#" class="dropdown-item" key="t-p-list">@lang('translation.Projects_List')</a>
                                    <a href="#" class="dropdown-item" key="t-p-overview">@lang('translation.Project_Overview')</a>
                                    <a href="#" class="dropdown-item" key="t-create-new">@lang('translation.Create_New')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-task">
                                    <a href="#" class="dropdown-item" key="t-task-list">@lang('translation.Task_List')</a>
                                    <a href="#" class="dropdown-item" key="t-kanban-board">@lang('translation.Kanban_Board')</a>
                                    <a href="#" class="dropdown-item" key="t-create-task">@lang('translation.Create_Task')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="#" class="dropdown-item" key="t-user-grid">@lang('translation.User_Grid')</a>
                                    <a href="#" class="dropdown-item" key="t-user-list">@lang('translation.User_List')</a>
                                    <a href="#" class="dropdown-item" key="t-profile">@lang('translation.Profile')</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-blog">
                                    <a href="#" class="dropdown-item" key="t-blog-list">@lang('translation.Blog_List')</a>
                                    <a href="#" class="dropdown-item" key="t-blog-grid">@lang('translation.Blog_Grid')</a>
                                    <a href="#" class="dropdown-item" key="t-blog-details">@lang('translation.Blog_Details')</a>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="#" class="dropdown-item" key="t-form-elements">@lang('translation.Form_Elements')</a>
                                    <a href="#" class="dropdown-item" key="t-form-layouts">@lang('translation.Form_Layouts')</a>
                                    <a href="#" class="dropdown-item" key="t-form-validation">@lang('translation.Form_Validation')</a>
                                    <a href="#" class="dropdown-item" key="t-form-advanced">@lang('translation.Form_Advanced')</a>
                                    <a href="#" class="dropdown-item" key="t-form-editors">@lang('translation.Form_Editors')</a>
                                    <a href="#" class="dropdown-item" key="t-form-upload">@lang('translation.Form_File_Upload')</a>
                                    <a href="#" class="dropdown-item" key="t-form-xeditable">@lang('translation.Form_Xeditable')</a>
                                    <a href="#" class="dropdown-item" key="t-form-repeater">@lang('translation.Form_Repeater')</a>
                                    <a href="#" class="dropdown-item" key="t-form-wizard">@lang('translation.Form_Wizard')</a>
                                    <a href="#" class="dropdown-item" key="t-form-mask">@lang('translation.Form_Mask')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    <a href="#" class="dropdown-item" key="t-basic-tables">@lang('translation.Basic_Tables')</a>
                                    <a href="#" class="dropdown-item" key="t-data-tables">@lang('translation.Data_Tables')</a>
                                    <a href="#" class="dropdown-item" key="t-responsive-table">@lang('translation.Responsive_Table')</a>
                                    <a href="#" class="dropdown-item" key="t-editable-table">@lang('translation.Editable_Table')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="#" class="dropdown-item" key="t-apex-charts">@lang('translation.Apex_Charts')</a>
                                    <a href="#" class="dropdown-item" key="t-e-charts">@lang('translation.E_Charts')</a>
                                    <a href="#" class="dropdown-item" key="t-chartjs-charts">@lang('translation.Chartjs_Charts')</a>
                                    <a href="#" class="dropdown-item" key="t-flot-charts">@lang('translation.Flot_Charts')</a>
                                    <a href="#" class="dropdown-item" key="t-ui-charts">@lang('translation.Toast_UI_Charts')</a>
                                    <a href="#" class="dropdown-item" key="t-knob-charts">@lang('translation.Jquery_Knob_Charts')</a>
                                    <a href="#" class="dropdown-item" key="t-sparkline-charts">@lang('translation.Sparkline_Charts')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="#" class="dropdown-item" key="t-boxicons">@lang('translation.Boxicons')</a>
                                    <a href="#" class="dropdown-item" key="t-material-design">@lang('translation.Material_Design')</a>
                                    <a href="#" class="dropdown-item" key="t-dripicons">@lang('translation.Dripicons')</a>
                                    <a href="#" class="dropdown-item" key="t-font-awesome">@lang('translation.Font_awesome')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-map">
                                    <a href="#" class="dropdown-item" key="t-g-maps">@lang('translation.Google_Maps')</a>
                                    <a href="#" class="dropdown-item" key="t-v-maps">@lang('translation.Vector_Maps')</a>
                                    <a href="#" class="dropdown-item" key="t-l-maps">@lang('translation.Leaflet_Maps')</a>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-more">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                    <a href="#" class="dropdown-item" key="t-invoice-list">@lang('translation.Invoice_List')</a>
                                    <a href="#" class="dropdown-item" key="t-invoice-detail">@lang('translation.Invoice_Detail')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    <a href="#" class="dropdown-item" key="t-login">@lang('translation.Login')</a>
                                    <a href="#" class="dropdown-item" key="t-login-2">@lang('translation.Login') 2</a>
                                    <a href="#" class="dropdown-item" key="t-register">@lang('translation.Register')</a>
                                    <a href="#" class="dropdown-item" key="t-register-2">@lang('translation.Register') 2</a>
                                    <a href="#" class="dropdown-item" key="t-recover-password">@lang('translation.Recover_Password')</a>
                                    <a href="#" class="dropdown-item" key="t-recover-password-2">@lang('translation.Recover_Password') 2</a>
                                    <a href="#" class="dropdown-item" key="t-lock-screen">@lang('translation.Lock_Screen')</a>
                                    <a href="#" class="dropdown-item" key="t-lock-screen-2">@lang('translation.Lock_Screen') 2</a>
                                    <a href="#" class="dropdown-item" key="t-confirm-mail">@lang('translation.Confirm_Mail')</a>
                                    <a href="#" class="dropdown-item" key="t-confirm-mail-2">@lang('translation.Confirm_Mail') 2</a>
                                    <a href="#" class="dropdown-item" key="t-email-verification">@lang('translation.Email_verification')</a>
                                    <a href="#" class="dropdown-item" key="t-email-verification-2">@lang('translation.Email_verification') 2</a>
                                    <a href="#" class="dropdown-item" key="t-two-step-verification">@lang('translation.Two_step_verification')</a>
                                    <a href="#" class="dropdown-item" key="t-two-step-verification-2">@lang('translation.Two_step_verification') 2</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                    <a href="#" class="dropdown-item" key="t-starter-page">@lang('translation.Starter_Page')</a>
                                    <a href="#" class="dropdown-item" key="t-maintenance">@lang('translation.Maintenance')</a>
                                    <a href="#" class="dropdown-item" key="t-coming-soon">@lang('translation.Coming_Soon')</a>
                                    <a href="#" class="dropdown-item" key="t-timeline">@lang('translation.Timeline')</a>
                                    <a href="#" class="dropdown-item" key="t-faqs">@lang('translation.FAQs')</a>
                                    <a href="#" class="dropdown-item" key="t-pricing">@lang('translation.Pricing')</a>
                                    <a href="#" class="dropdown-item" key="t-error-404">@lang('translation.Error_404')</a>
                                    <a href="#" class="dropdown-item" key="t-error-500">@lang('translation.Error_500')</a>
                                </div>
                            </div>
                        </div>
                    </li>

...
class EmailTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.email_templates.email_templates', compact('emailtemplates', 'emailtemplate'));
    }
    ...
    public function store(EmailTemplateRequest $request)
    {
        ...
        if (empty($emailtemplet)) {
            toastr()->error('Email template updated successfully..!');
